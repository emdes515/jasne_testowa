                  ...
                  <div className="flex items-center gap-3">
                    <div className="text-right">
                      <span className={`text-sm font-bold ${
                        isFullScore ? 'text-emerald-400' : isPartial ? 'text-amber-400' : 'text-red-400'
                      }`}>
                    ...
                    >
                      ...
                      {!task.isClosed && (
                        <div className="mb-4 bg-white/5 p-3 rounded-xl border border-white/5">
                          <span className="text-xs text-[#8B8D98] block mb-1">Przyznane punkty według klucza maturalnego:</span>
