...
export function OnboardingOverlay({
  ...
  // 4 Steps Flow:
  // Step 1: Wybór celu maturalnego (Tylko Matura 2025)
  ...
  const goalOptions: GoalOption[] = [
    ...
    },
    {
      ...
      subtitle: 'Święty spokój, zero stresu • Pewniaki i schematy maturalne',
      icon: ShieldCheck,
    ...
    },
    {
      ...
      exam: 'matura_2025',
      score: '100',
      title: '100% • Prestiż i top uczelnie',
    ...
    },
    {
      ...
      subtitle: 'Tryb ratunkowy • Powtórka kluczowych pewniaków za 1 pkt',
      icon: Zap,
      badgeText: 'RATUNEK',
      badgeVariant: 'amber'
    }
    ...
    >
      ...
      <div className="relative z-10 flex-1 overflow-y-auto overflow-x-hidden px-4 sm:px-6 py-4 max-w-xl mx-auto w-full flex flex-col justify-between overscroll-y-contain">
        <AnimatePresence mode="wait">
          {/* ======================================================== */}
          {/* KROK 1: Wybór celu maturalnego (Tylko Matura 2025)       */}
          {/* ======================================================== */}
          {currentStep === 1 && (
            <motion.div
              key="step-1"
            ...
            >
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight">
                  W co celujesz na maturze (Formuła 2023)?
                </h2>
              ...
              {/* 4 Matura Goals - Fits cleanly without scrolling */}
          ...
          {currentStep === 2 && (
            ...
            >
              <div>
                ...
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Zobacz, jak szybko klikają schematy maturalne, gdy znasz właściwy wzór.
                </p>
              </div>
              ...
              <div className="bg-[#0E1522]/90 border border-white/10 rounded-2xl p-4 flex flex-col gap-3">
                ...
                {showWrongTip && !isTaskSolved && (
                  <motion.div
                    ...
                    className="p-3 bg-amber-500/15 border border-amber-500/30 rounded-xl text-amber-300 text-xs flex items-center gap-2"
                  >
                  ...
                  >
                    <div className="flex items-center gap-2">
                      ...
                      <span className="text-xs font-bold text-white">
                        Genialnie! Właśnie opanowałeś pewniaka maturalnego z potęg.
                      </span>
                    </div>
          ...
          {currentStep === 3 && (
            ...
            >
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight">
                  Twój maturalny ekosystem
                </h2>
                <p className="text-xs sm:text-sm text-slate-400 mt-1">
                  Trzy filary, dzięki którym przygotujesz się do matury bez wypalenia:
                </p>
              </div>
              ...
              <div className="flex flex-col gap-3 my-auto">
                ...
                <div className="bg-[#0E1522]/90 border border-amber-500/30 rounded-2xl p-4 shadow-[0_4px_15px_rgba(255,184,0,0.06)]">
                  <div className="flex items-start gap-3.5">
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-slate-300 leading-relaxed">
                        Uczysz się tylko tego, co naprawdę pojawia się w arkuszach maturalnych. Zero zbędnej teorii – czysta praktyka maturalna.
                      </p>
                    </div>
                  </div>
                </div>
                ...
                <div className="bg-[#0E1522]/90 border border-amber-500/30 rounded-2xl p-4 shadow-[0_4px_15px_rgba(245,158,11,0.06)]">
                  <div className="flex items-start gap-3.5">
          ...
          {currentStep === 4 && (
            ...
            >
              <div>
                ...
                <h2 className="text-2xl sm:text-3xl font-bold text-white leading-tight">
                  Twój plan nauki na Nową Formułę 2023 jest gotowy!
                </h2>
