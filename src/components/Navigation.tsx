...
export function Navigation({ currentTab, setTab, userState, onProfileClick }: NavigationProps) {
  ...
  return (
    <>
      ...
      >
        <div className="pointer-events-auto flex items-center justify-between gap-1 bg-[#0B0E14]/95 backdrop-blur-[24px] border border-white/10 p-1.5 rounded-[26px] shadow-[0_12px_40px_rgba(0,0,0,0.8),0_0_20px_rgba(0,229,255,0.08)] w-full max-w-sm">
            ...
            return (
              <button 
                ...
                className={`relative flex items-center justify-center gap-1.5 py-2.5 px-3 rounded-2xl transition-all duration-200 select-none ${
                  isActive 
                    ? isArena
                      ? 'bg-emerald-500/15 border border-emerald-500/40 text-emerald-400 shadow-[0_0_16px_rgba(16,185,129,0.25)] flex-1 active:scale-[0.96]'
                      : 'bg-[#00E5FF]/15 border border-[#00E5FF]/40 text-[#00E5FF] shadow-[0_0_16px_rgba(0,229,255,0.2)] flex-1 active:scale-[0.96]' 
              ...
              >
                <div className={`relative transition-transform duration-200 ${isActive ? 'scale-105' : ''}`}>
                  <Icon size={20} className={isActive ? (isArena ? 'drop-shadow-[0_0_8px_rgba(16,185,129,0.8)]' : 'drop-shadow-[0_0_8px_rgba(0,229,255,0.6)]') : ''} />
                  {isArena && !isActive && (
                    <span className="absolute -top-1 -right-1 w-2 h-2 rounded-full bg-emerald-400 shadow-[0_0_8px_#10B981] animate-pulse" />
                  )}
                </div>
                {isActive && (
                  <span className="text-[11px] font-black tracking-wide whitespace-nowrap animate-in fade-in duration-200">
                    {item.label}
                  </span>
                )}
              </button>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1">
          <div className="w-11 h-11 rounded-2xl bg-gradient-to-br from-[#00E5FF] to-[#3B82F6] p-[2px] shadow-[0_0_15px_rgba(0,229,255,0.4)]">
            <div className="w-full h-full bg-[#0B0E14] rounded-2xl flex items-center justify-center">
              <span className="font-display font-black text-transparent bg-clip-text bg-gradient-to-br from-[#00E5FF] to-white text-base">
                MQ
              </span>
            </div>
          </div>
          <span className="text-[8px] font-black uppercase text-[#00E5FF]/70 tracking-widest mt-1">2025</span>
        </div>
                ...
                className={`w-full py-2.5 px-1 rounded-2xl flex flex-col items-center justify-center gap-1 transition-all duration-200 group relative ${
                  isActive
                    ? isArena
                      ...
                      : 'bg-[#00E5FF]/15 text-[#00E5FF] border border-[#00E5FF]/40 shadow-[0_0_16px_rgba(0,229,255,0.15)]'
                    : 'text-[#8B8D98] hover:text-white hover:bg-white/5'
                }`}
                title={item.label}
              >
                <div className="relative">
                  <Icon size={20} className={isActive ? (isArena ? 'text-emerald-400 drop-shadow-[0_0_8px_rgba(16,185,129,0.8)]' : 'text-[#00E5FF] drop-shadow-[0_0_8px_rgba(0,229,255,0.6)]') : 'group-hover:scale-110 transition-transform'} />
                  {isArena && !isActive && (
        ...
        <button
          ...
          className="w-11 h-11 rounded-full bg-gradient-to-br from-[#00E5FF]/30 to-[#3B82F6]/30 border border-[#00E5FF]/40 p-0.5 flex items-center justify-center hover:scale-105 active:scale-95 transition-transform"
          title="Twój profil"
        >
          <div className="w-full h-full bg-[#141A23] rounded-full flex items-center justify-center text-[#00E5FF]">
            <User size={18} />
          </div>
        </button>
      </aside>
      ...
      >
        <div className="flex flex-col gap-7">
          {/* Logo i Odznaka Formuła 2025 */}
          <div className="flex items-center gap-3 px-1">
            <div className="w-10 h-10 rounded-2xl bg-gradient-to-br from-[#00E5FF] via-[#00B4D8] to-[#3B82F6] p-[2px] shadow-[0_0_20px_rgba(0,229,255,0.4)] shrink-0">
              <div className="w-full h-full bg-[#0B0E14] rounded-2xl flex items-center justify-center">
            ...
            <div className="min-w-0 flex flex-col">
              <div className="flex items-center gap-1.5">
                <span className="font-display font-black text-white text-base tracking-tight truncate">
                  Matura Quest
                </span>
              </div>
              <span className="inline-flex items-center gap-1 text-[10px] font-black uppercase tracking-wider text-[#00E5FF] bg-[#00E5FF]/10 border border-[#00E5FF]/30 px-2 py-0.5 rounded-full w-fit mt-0.5 shadow-[0_0_10px_rgba(0,229,255,0.15)]">
                Matura 2025
              </span>
            </div>
          </div>
              ...
              return (
                  ...
                  className={`w-full flex items-center gap-3 px-3.5 py-3 rounded-2xl transition-all duration-200 text-left group cursor-pointer ${
                    isActive
                      ? isArena
                        ...
                        : 'bg-gradient-to-r from-[#00E5FF]/15 via-[#00E5FF]/10 to-transparent border border-[#00E5FF]/40 text-[#00E5FF] shadow-[0_0_20px_rgba(0,229,255,0.12)] font-black'
                ...
                >
                  ...
                  <div className="flex flex-col min-w-0 flex-1">
                    ...
                    <span className={`text-[11px] font-normal truncate ${isActive ? (isArena ? 'text-emerald-400/80' : 'text-[#00E5FF]/80') : 'text-[#6B7280]'}`}>
                      {item.sublabel}
                    </span>
                  </div>
                </button>
        ...
        <div 
          ...
          className="bg-[#141A23] hover:bg-[#18202C] border border-white/10 hover:border-[#00E5FF]/40 rounded-2xl p-3.5 flex items-center gap-3 transition-all duration-200 cursor-pointer group shadow-lg"
          title="Kliknij, aby otworzyć profil i osiągnięcia"
        >
          <div className="relative shrink-0">
            <div className="w-10 h-10 rounded-full bg-gradient-to-br from-[#00E5FF] to-[#3B82F6] p-[2px] shadow-[0_0_12px_rgba(0,229,255,0.3)] group-hover:shadow-[0_0_16px_rgba(0,229,255,0.5)] transition-shadow">
              <div className="w-full h-full bg-[#0B0E14] rounded-full flex items-center justify-center">
                <User size={18} className="text-[#00E5FF]" />
              </div>
            </div>
            <div className="absolute -bottom-1 -right-1 bg-[#00E5FF] text-black text-[9px] font-black px-1.5 py-0.2 rounded-full border border-[#0B0E14] shadow-sm">
              L{currentLevel}
            </div>
          </div>
          ...
          <div className="flex-1 min-w-0">
            <div className="flex items-center justify-between">
              <span className="font-display font-black text-white text-xs truncate group-hover:text-[#00E5FF] transition-colors">
                Konto Ucznia
              </span>
            ...
            <div className="w-full h-1.5 bg-[#0B0E14] rounded-full overflow-hidden mt-1 border border-white/5">
              <div 
                className="h-full bg-gradient-to-r from-[#00A3FF] to-[#00E5FF] rounded-full"
                style={{ width: `${xpPct}%` }}
              />
            </div>
          </div>
