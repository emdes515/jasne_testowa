    ...
    <>
      ...
      >
        ...
        <div className="flex flex-col items-center gap-1">
          ...
          <span className="text-[8px] font-semibold uppercase text-slate-400 tracking-wider mt-1">NF 2023</span>
        </div>
        ...
        <div className="flex flex-col gap-7">
          ...
          <div className="flex items-center gap-3 px-1">
            ...
            <div className="min-w-0 flex flex-col">
              ...
              <span className="inline-flex items-center gap-1.5 text-[10px] font-medium tracking-tight text-cyan-300 bg-cyan-500/10 border border-cyan-500/20 px-2 py-0.5 rounded-full w-fit mt-0.5">
