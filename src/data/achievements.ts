...
export const ACHIEVEMENTS: Achievement[] = [
  ...
  {
    id: 'tasks_master',
    name: 'Mistrz Zadań Maturalnych',
    description: 'Rozwiązuj zadania z bazy egzaminacyjnej matematyki.',
    category: 'tasks',
    iconName: 'CheckCircle2',
