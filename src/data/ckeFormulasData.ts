...
export const CKE_FORMULAS_DATA: CkeFormulaItem[] = [
  // 1. Potęgi i Pierwiastki
  {
    ...
    formula: 'a^r · a^s = a^{r+s},       a^r / a^s = a^{r-s}',
  ...
  },
  {
    ...
    formula: '(a^r)^s = a^{r·s},       (a · b)^r = a^r · b^r',
  ...
  },
  {
    ...
    topicId: 'potegi-pierwiastki',
    topicName: 'Potęgi i Pierwiastki',
    title: 'Ujemny i ułamkowy wykładnik potęgi',
    formula: 'a^{-r} = 1 / a^r,       a^{m/n} = ⁿ√(a^m)',
  ...
  },
  {
    ...
    topicId: 'potegi-pierwiastki',
    topicName: 'Potęgi i Pierwiastki',
    title: 'Iloczyn i iloraz pod pierwiastkiem',
    formula: 'ⁿ√(a · b) = ⁿ√a · ⁿ√b,       ⁿ√(a / b) = ⁿ√a / ⁿ√b',
  ...
  // 2. Logarytmy i Procenty
  {
    ...
    formula: 'log_a(b) = c   <=>   a^c = b   (gdzie a > 0, a ≠ 1, b > 0)',
  ...
  },
  {
    ...
    topicId: 'logarytmy-procenty',
    topicName: 'Logarytmy i Procenty',
    title: 'Działania na logarytmach (suma, różnica, potęga)',
    formula: 'log_a(x) + log_a(y) = log_a(x · y)\nlog_a(x) - log_a(y) = log_a(x / y)\nk · log_a(x) = log_a(x^k)',
  ...
  },
  {
    ...
    formula: 'Zmiana: (A - B) / B · 100%\nKapitał końcowy: K_n = K_0 · (1 + p / (100 · m))^(n · m)',
  ...
  // 3. Funkcje i Równania
  {
    ...
    title: 'Funkcja liniowa f(x) = ax + b',
    formula: 'f(x) = ax + b\nMiejsce zerowe: x_0 = -b / a\nPunkt przecięcia z osią OY: (0, b)\nWarunek równoległości: a_1 = a_2\nWarunek prostopadłości: a_1 · a_2 = -1',
  ...
  },
  {
    ...
    formula: 'Δ = b² - 4ac\nWierzchołek W = (p, q), gdzie p = -b / (2a), q = -Δ / (4a)\nPostać kanoniczna: f(x) = a(x - p)² + q\nPostać iloczynowa (dla Δ ≥ 0): f(x) = a(x - x_1)(x - x_2)',
  ...
  // 4. Ciągi Liczbowe
  {
    ...
    formula: 'Wzór ogólny: a_n = a_1 + (n - 1) · r\nZwiązek sąsiadów: a_n = (a_{n-1} + a_{n+1}) / 2\nSuma n wyrazów: S_n = ((a_1 + a_n) / 2) · n',
  ...
  },
  {
    ...
    formula: 'Wzór ogólny: a_n = a_1 · q^{n-1}\nZwiązek sąsiadów: a_n² = a_{n-1} · a_{n+1}\nSuma n wyrazów (q ≠ 1): S_n = a_1 · (1 - q^n) / (1 - q)',
  ...
  // 5. Trygonometria
  {
    ...
    formula: 'sin α = a / c (przyprostokątna naprzeciw / przeciwprostokątna)\ncos α = b / c (przyprostokątna przyległa / przeciwprostokątna)\ntg α = a / b = sin α / cos α',
  ...
  },
  {
    ...
    topicId: 'trygonometria',
    topicName: 'Trygonometria',
    title: 'Tabela wartości kątów 30°, 45°, 60°',
    formula: 'sin 30° = 1/2,   sin 45° = √2/2,   sin 60° = √3/2\ncos 30° = √3/2,   cos 45° = √2/2,   cos 60° = 1/2\ntg 30° = √3/3,   tg 45° = 1,   tg 60° = √3',
  ...
  // 6. Planimetria i Geometria Analityczna
  {
    ...
    formula: 'Długość |AB| = √[(x_B - x_A)² + (y_B - y_A)²]\nŚrodek S = ((x_A + x_B) / 2,  (y_A + y_B) / 2)',
  ...
  },
  {
    ...
    formula: 'Wysokość: h = (a√3) / 2\nPole: P = (a²√3) / 4\nPromień koła opisanego: R = 2/3 h = (a√3) / 3\nPromień koła wpisanego: r = 1/3 h = (a√3) / 6',
