...
def get_topic_02_visuals(l_idx):
    ...
    if l_num == 1:
        ...
        tab0 = {
            ...
            'formulaBadge': '\\log_a x + \\log_a y = \\log_a(x \\cdot y), \\quad \\log_a x - \\log_a y = \\log_a\\left(\\frac{x}{y}\\right)',
            ...
            'cards': [
                {
                    ...
                    'formula': '\\log_6 4 + \\log_6 9 = \\log_6(4 \\cdot 9) = \\log_6 36 = 2',
                    'desc': 'Zamiast liczyć osobno, łączysz liczby logarytmowane pod jednym dachem.',
                    'color': C_SKY
                },
                {
                    'badge': 'Zasada 2: Różnica',
                    'title': 'Odejmowanie zamienia się w iloraz',
                    'formula': '\\log_2 40 - \\log_2 5 = \\log_2\\left(\\frac{40}{5}\\right) = \\log_2 8 = 3',
                    'desc': 'Odejmowanie logarytmów dzieli liczby logarytmowane przez siebie.',
                    'color': C_PURPLE
                }
            ],
            'metrics': [
                {'label': 'Suma logarytmów', 'value': '$\\log_a(x \\cdot y)$', 'color': C_SKY},
                {'label': 'Różnica logarytmów', 'value': '$\\log_a(x : y)$', 'color': C_PURPLE},
                {'label': 'Warunek bezwzględny', 'value': 'Identyczna podstawa $a > 0, a \\neq 1$', 'color': C_PRIMARY}
            ]
        }
        return {'tab0': tab0, 'tab2': None, 'tab3': None}
        ...
        tab0 = {
            ...
            'formulaBadge': 'k \\cdot \\log_a x = \\log_a(x^k), \\quad \\log_a b = \\frac{\\log_c b}{\\log_c a}',
            ...
            'cards': [
                {
                    ...
                    'formula': '2\\log_5 10 - \\log_5 4 = \\log_5(10^2) - \\log_5 4 = \\log_5\\left(\\frac{100}{4}\\right) = \\log_5 25 = 2',
                    'desc': 'Najpierw wciągasz liczbę przed logarytmem do środka, a dopiero potem łączysz logarytmy!',
                    'color': C_PRIMARY
                },
                {
                    'badge': 'Wzór ratunkowy',
                    'title': 'Zamiana podstawy logarytmu',
                    'formula': '\\log_4 8 = \\frac{\\log_2 8}{\\log_2 4} = \\frac{3}{2} = 1{,}5',
                    'desc': 'Gdy podstawy są różne, sprowadzasz oba wyrazy do wspólnej bazy (np. 2).',
                    'color': C_SUCCESS
                }
            ],
            'metrics': [
                {'label': 'Zasada pierwszeństwa', 'value': 'Najpierw wciągnij $k$ do potęgi $x^k$', 'color': C_PRIMARY},
                {'label': 'Częsty współczynnik', 'value': '$\\frac{1}{2}\\log_a x = \\log_a \\sqrt{x}$', 'color': C_SKY},
