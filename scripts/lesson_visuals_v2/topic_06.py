...
def get_topic_06_visuals(l_idx):
    ...
    if l_num == 1:
        ...
        tab0 = {
            ...
            'formulaBadge': r'A \cdot B = 0 \implies A = 0 \quad \text{lub} \quad B = 0',
            ...
            'cards': [
                ...
                },
                {
                    ...
                    'formula': r'2x + 1 = 0 \implies x = -\frac{1}{2}',
            ...
            'cards': [
                {
                    ...
                    'formula': r'x^2 - 9 = 0 \implies x = 3 \quad \text{lub} \quad x = -3',
            ...
            'cards': [
                {
                    ...
                    'desc': 'Wyciągasz wspólny czynnik $3x$. W nawiasie powstaje różnica kwadratów: $3x(x - 2)(x + 2) = 0$.',
                    'color': C_PRIMARY
                },
                {
                    'badge': 'Kardynalny zakaz',
                    'title': 'Nigdy nie dziel przez x!',
                    'formula': r'x^2 = 5x \implies x(x - 5) = 0 \implies x = 0 \quad \text{lub} \quad x = 5',
